...
var CanvasCycle = {
	...
	loadImage: function(name) {
		...
		let hideLoading = this.hideLoading;
		let run = this.hideLoading;
		
		//var url = 'image.php?file='+name+'&callback=CanvasCycle.processImage';
		//scr.src = imageCallback;
		/*
		imagePath = "/assets/color-cycling-pixel-art/" + name + ".png"
		*/
		imagePath = "assets/canvas-cycle/images/" + name + ".LBM.json";
		jQuery.cachedScript(imagePath).done(function(script,textStatus) {
				//console.log(`script=${script}`);
				console.log(`textStatus=${textStatus}`);

				var scr = document.createElement('SCRIPT');
				scr.type = 'text/javascript';
				scr.innerHTML = "CanvasCycle.processImage("+script+");";
